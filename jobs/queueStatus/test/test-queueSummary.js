/**
 * Test file for Job: queueSummary
 */

var assert = require ('assert');
var queueSummary_SUT = require('../queueSummary');

var mockedConfig, mockedDependencies;

describe ('queueSummary test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      queueSummary_SUT.onRun(config, mockedDependencies, function(err, data){
